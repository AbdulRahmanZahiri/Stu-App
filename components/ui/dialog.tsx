...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    {/* Backdrop */}
    <DialogOverlay />
    {/* Scroll container — sits above backdrop, handles tall dialogs */}
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex min-h-full items-center justify-center p-4">
        <DialogPrimitive.Content
          ref={ref}
          className={cn(
            'relative w-full max-w-lg gap-4 bg-white p-6 shadow-xl rounded-2xl my-8 duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95',
            className
          )}
          {...props}
        >
