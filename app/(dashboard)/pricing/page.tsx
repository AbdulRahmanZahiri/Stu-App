...
import {
  Check, Sparkles, Headphones, BrainCircuit, Zap, Lock,
  Crown, Star, ArrowRight, GraduationCap,
} from 'lucide-react'
...
export default function PricingPage() {
  ...
  return (
    <div className="min-h-full bg-gradient-to-b from-slate-50 to-white p-6 lg:p-10">
      {/* Header */}
      <motion.div
        ...
        >
          ...
          <ul className="mb-8 flex-1 space-y-2.5">
            ...
            <li className="flex items-start gap-2.5 text-sm text-slate-400">
              ...
              AI Assistant <span className="text-xs">(Pro only)</span>
            </li>
            <li className="flex items-start gap-2.5 text-sm text-slate-400">
              <Lock className="mt-0.5 h-4 w-4 shrink-0" />
              Audio Podcasts <span className="text-xs">(Pro only)</span>
            </li>
          </ul>
